...
function mainMenu() {
  ...
  if (selection == "first40") {
    ...
    let rand100Grade = Math.floor(Math.random() * grades.length);
    grades.splice(rand100Grade, 1, 100);
    ...
    grades.splice(grades.length - 1, 0, randGrade);
    ...
    outputEl2.innerHTML = `The Number of grades below 50 are: ${result}`;
